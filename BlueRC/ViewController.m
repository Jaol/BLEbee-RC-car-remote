...
-(IBAction)backward{
    movingValueFB = 2;[self processAnalogControls];
...
-(IBAction)left{
    movingValueLR = 3;[self processAnalogControls];
    /*
...
-(IBAction)right{
    movingValueLR = 4;[self processAnalogControls];
    /*
...
-(void)processAnalogControls{
    ...
    if([ble isConnected]){
        ...
        if (movingValueLR == 99 && movingValueFB == 1)
            buf[0] = 1;
        
        if (movingValueLR == 99 && movingValueFB == 2)
            buf[0] = 2;
        
        
        if (movingValueLR == 3 && movingValueFB == 1)
            buf[0] = 3;
        
        if (movingValueLR == 4 && movingValueFB == 1)
            buf[0] = 4;
        
        if (movingValueLR == 3 && movingValueFB == 2)
            buf[0] = 5;
        
        if (movingValueLR == 4 && movingValueFB == 2)
            buf[0] = 6;
         
        
        if (movingValueLR == 3 && movingValueFB == 99)
            buf[0] = 7;
        
        if (movingValueLR == 4 && movingValueFB == 99)
            buf[0] = 8;
        
        if (movingValueLR == 99 && movingValueFB == 99)
           buf[0] = 99;
